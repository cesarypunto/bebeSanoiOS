...
class DatePickerDialog: UIView {
    ...
    init() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector : #selector(DatePickerDialog.deviceOrientationDidChange), name: UIDeviceOrientationDidChangeNotification, object: nil)
    }
    ...
    func show(title: String, datePickerMode: UIDatePickerMode = .DateAndTime, callback: ((date: NSDate) -> Void)) {
        show(title, doneButtonTitle: "Aceptar", cancelButtonTitle: "Cancelar", datePickerMode: datePickerMode, callback: callback)
    }
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.doneButton.addTarget(self, action: #selector(DatePickerDialog.buttonTapped), forControlEvents: UIControlEvents.TouchUpInside)
